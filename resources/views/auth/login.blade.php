                ...
                <div class="app-brand justify-content-center mt-5">
                    <a href="{{ url('/') }}" class="app-brand-link gap-2">
                        <span class="app-brand-logo demo">
                          <img src="{{ asset('assets/img/sinavclogo.png') }}" alt="موسسه حقوقی دادورزان امین" width="40">
                        </span>
                        <span class="app-brand-text demo text-heading fw-bold">موسسه حقوقی دادورزان امین</span>
                    </a>
                </div>

                <div class="card-body mt-2">
                    <h4 class="mb-2 fw-semibold">داشبورد مدیریتی دادورزان امین</h4>
