            ...
            <div class="row row-gap-4 justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="team-item top-reveal">
                        ...
                        <div class="name-details">
                            <h4><a href="javascript: void(0);">مهشید رجبی</a> </h4>
                            <p>مهندس ارشد هوش مصنوعی</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="team-item top-reveal">
                        ...
                        <div class="name-details">
                            <h4><a href="javascript: void(0);">امیرارسلان رهنما</a> </h4>
                            <p>مدیر خلاق</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="team-item top-reveal">
                        ...
                        <div class="name-details">
                            <h4><a href="javascript: void(0);">فاطمه میرزایی</a> </h4>
                            <p>طراح محصول</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="team-item top-reveal">
                        ...
                        <div class="name-details">
                            <h4><a href="javascript: void(0);"> النا باباخانی</a></h4>
                            <p>دانشمند تحقیقاتی هوش مصنوعی</p>
                        </div>
                    </div>
                </div>
            </div>
